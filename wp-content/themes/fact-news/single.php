...
<main id="primary" class="site-main">
	...
	while ( have_posts() ) :
		...
		the_post_navigation(
			array(
				'prev_text' => '<span class="nav-subtitle">' . esc_html__( 'Previous:', 'fact-news' ) . '</span> <span class="nav-title">%title</span>',
				'next_text' => '<span class="nav-subtitle">' . esc_html__( 'Next:', 'fact-news' ) . '</span> <span class="nav-title">%title</span>',
			)
		);
		...
		if ( is_singular( 'post' ) ) {
			...
			if ( $query->have_posts() ) :
				$related_title = get_theme_mod( 'fact_news_related_posts_title', __( 'Related Posts', 'fact-news' ) );
				?>

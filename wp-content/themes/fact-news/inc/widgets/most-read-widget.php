<?php
if ( ! class_exists( 'Fact_News_Most_Read_Widget' ) ) {
	/**
	 * Adds Fact News Most Read Widget.
	 */
	class Fact_News_Most_Read_Widget extends WP_Widget {
		...
		public function __construct() {
			$most_read_widget = array(
				...
				'description' => __( 'Retrive Most Read Widgets', 'fact-news' ),
			);
			parent::__construct(
				'fact_news_most_read_widget',
				__( 'Adore Widget: Most Read Widget', 'fact-news' ),
				$most_read_widget
			);
		}
		...
		public function form( $instance ) {
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php esc_html_e( 'Number of posts to show (Min:1 | Max:8 ):', 'fact-news' ); ?></label>

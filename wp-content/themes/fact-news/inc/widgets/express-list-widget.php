<?php
if ( ! class_exists( 'Fact_News_Express_List_Widget' ) ) {
	/**
	 * Adds Fact News Express List Widget.
	 */
	class Fact_News_Express_List_Widget extends WP_Widget {
		...
		public function __construct() {
			$express_list_widget = array(
				...
				'description' => __( 'Retrive Express List Widgets', 'fact-news' ),
			);
			parent::__construct(
				'fact_news_express_list_widget',
				__( 'Adore Widget: Express List Widget', 'fact-news' ),
				$express_list_widget
			);
		}

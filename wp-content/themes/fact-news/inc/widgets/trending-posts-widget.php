<?php
if ( ! class_exists( 'Fact_News_Trending_Posts_Widget' ) ) {
	/**
	 * Adds Fact News Trending Posts Widget.
	 */
	class Fact_News_Trending_Posts_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$trending_posts_widget = array(
				'classname'   => 'widget adore-widget trending-posts-widget',
				'description' => __( 'Retrive Trending Posts Widgets', 'fact-news' ),
			);
			parent::__construct(
				'fact_news_trending_posts_widget',
				__( 'Adore Widget: Trending Posts Widget', 'fact-news' ),
		...
		public function widget( $args, $instance ) {
			...
			$viewall_button_link   = ( ! empty( $instance['view_all_button_link'] ) ) ? $instance['view_all_button_link'] : esc_url( get_category_link( $trending_posts_category ) );
